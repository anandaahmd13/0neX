  ...
  return (
    <div className="space-y-6">
      <PageTitle
        ...
        subtitle="Satu pintu buat menjalankan agent lokal. Provider pertama: Claude Code CLI."
      />

      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Badge color="ok">Gateway lokal</Badge>
        ...
        <Card>
          <CardBody className="flex flex-col items-center gap-3 py-12 text-center">
            <p className="text-sm text-ink/60">
              Belum ada sesi Gateway. Claude CLI berjalan lokal dan secret tetap di server.
            </p>
